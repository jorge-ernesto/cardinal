                ...
                <div id="listadoRegistros">
                    <div class="card border-primary"> <!-- card bg-light -->
                        ...
                        <div class="card-body text-primary"> <!-- card-body -->
                            ...
                            <h4>
                                <a id="wea" class="btn btn-primary mr-2" href="javascript:mostrarForm(true)">Crear Cargos</a>
                            </h4>
                    ...
                    <div class="card bg-dark text-white">
                        ...
                        <div class="card-body">
                            ...
                            <form method="post" id="formulario"> <!-- novalidate -->
                                ...
                                <div class="row form-group">
                                    <label for="permisos" class="col-form-label col-md-2">Permisos:</label>
                                    <div class="col-md-5">
                                        <span id="permisos">
                                ...
                                <h4>
                                    <button type="submit" id="crear" class="btn btn-secondary">Crear Cargo</button>
