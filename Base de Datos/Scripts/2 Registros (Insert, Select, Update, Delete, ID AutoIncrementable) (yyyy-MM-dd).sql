...
insert into categoria (nombre,descripcion,estado) values('Descripción 1','Descripción 1',1);
insert into categoria (nombre,descripcion,estado) values('Descripción 2','Descripción 2',1);
insert into categoria (nombre,descripcion,estado) values('Descripción 3','Descripción 3',1);
insert into categoria (nombre,descripcion,estado) values('Descripción 4','Descripción 4',1);
insert into categoria (nombre,descripcion,estado) values('Descripción 5','Descripción 5',1);
