...
insert into usuarios (nombre,tipo_documento,num_documento,direccion,telefono,email,cargo,username,password,imagen,estado) values('Jorge Ernesto','DNI','73704296',null,null,null,'Administrador','admin','21232f297a57a5a743894a0e4a801fc3','5.jpg',1); /* admin */
insert into usuarios (nombre,tipo_documento,num_documento,direccion,telefono,email,cargo,username,password,imagen,estado) values('Lilia Sturman','DNI','99999999',null,null,null,'Usuario','lilia','e5b5a57b9d168fbdd42a1e8799dd59c3','KKK.jpg',1); /* lilia */
