...
if (!function_exists('ejecutarConsulta')) {
    function ejecutarConsulta($sql) {
        ...
        $query = $conexion->query($sql); // Declaramos una nueva variable, y ejecuta la sentencia query, que esta recibiendo por parámetro el código SQL
    ...
    function ejecutarConsultaSimpleFila($sql) {
        ...
        $row = $query->fetch_assoc(); // Obtenemos una fila como resultado en un array
    ...
    function limpiarCadena($str) {
        global $conexion;
        $str = mysqli_real_escape_string($conexion,trim($str)); // Escapamos los caracteres especiales de una cadena, usamos la codificación de los caracteres que definimos anteriormente
        return htmlspecialchars($str); // Retornamos la cadena
    }
}
