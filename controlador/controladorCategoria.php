    ...
    case 'listar';
        ...
        while ($registro = $respuesta->fetch_object()) { // Recorremos todos los registros que obtenemos de la tabla categoria
            $data[] = array( // Todos los registros obtenidos se almacenan en el array $data declarado en la parte superior
                '0' => ($registro->con_cat)? // Si la condición es true ó 1 entonces se podrá desactivar, si la condición es false ó 0 entonces se podrá activar
                ...
                '1' => $registro->nom_cat,
                '2' => $registro->des_cat,
                '3' => ($registro->con_cat)? // Si la condición es true ó 1 entonces se mostrará un label Activado, si la condición es false ó 0 entonces se mostrará un label Desactivado
